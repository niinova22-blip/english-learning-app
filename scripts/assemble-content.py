...
VOCAB2_FILES = ["health-medicine.json", "environment-energy.json", "technology-innovation.json", "education-learning.json", "history-culture.json", "psychology-behaviour.json", "politics-governance.json", "media-communication.json"]
